...
const footerLinks = [
  ...
  },
  {
    ...
    links: [
      { label: "من نحن", href: "#" },
      { label: "تواصل معنا", href: "mailto:hello@sanadai.com" },
      { label: "المدونة", href: "#" },
    ],
  },
  {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="md:col-span-1">
            <Link href="/" className="flex items-center gap-2 mb-4">
              ...
              <span className="text-white font-bold text-xl">سند</span>
            </Link>
            <p className="text-white/50 text-sm leading-relaxed">
              المساعد الذكي لمتجرك على سلة. ردود تلقائية، تتبع طلبات، وخدمة عملاء على مدار الساعة.
            </p>
            {/* Social */}
        ...
        <div className="border-t border-white/10 mt-12 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-white/40 text-sm">
            © {year} سند AI. جميع الحقوق محفوظة.
          </p>
          <p className="text-white/40 text-sm">
            صُنع بـ ❤️ للمتاجر السعودية
          </p>
        </div>
      </div>
    </footer>
