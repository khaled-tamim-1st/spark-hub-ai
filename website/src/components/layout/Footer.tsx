...
function IconX() {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 text-slate-500 hover:text-[#3B4FE8] transition-colors" aria-hidden="true">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-10 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-xs text-slate-400 font-bold">
              <li>
                <a href="#features" className="hover:text-[#7B8FFF] transition-colors">المميزات الرئيسية</a>
              </li>
              <li>
                <a href="#roi-calculator" className="hover:text-[#7B8FFF] transition-colors">حاسبة التوفير (ROI)</a>
              </li>
              <li>
                <a href="#how-it-works" className="hover:text-[#7B8FFF] transition-colors">كيف يعمل Ecomate؟</a>
              </li>
              <li>
                <a href="#integrations" className="hover:text-[#7B8FFF] transition-colors">التكاملات والشركاء</a>
              </li>
              <li>
                <a href="#pricing" className="hover:text-[#7B8FFF] transition-colors">خطط الأسعار</a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-xs text-slate-400 font-bold">
              <li>
                <a href={getAppUrl("/login")} className="hover:text-[#7B8FFF] transition-colors flex items-center gap-1">
                  <span>تسجيل الدخول</span>
                  <ExternalLink size={11} className="text-slate-500" />
                </a>
              </li>
              <li>
                <a href={getAppUrl("/register")} className="hover:text-[#7B8FFF] transition-colors flex items-center gap-1">
                  <span>إنشاء حساب جديد</span>
                  <ExternalLink size={11} className="text-slate-500" />
                </a>
              </li>
              <li>
                <a href="#faq" className="hover:text-[#7B8FFF] transition-colors">مركز الأسئلة والمساعدة</a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-xs text-slate-400 font-medium mb-5">
              <li>
                <a href="mailto:hello@ecomate.ai" className="hover:text-[#7B8FFF] transition-colors font-bold">hello@ecomate.ai</a>
              </li>
              <li>
