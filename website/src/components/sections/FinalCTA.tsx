        ...
        <div className="relative rounded-[2.5rem] bg-gradient-to-br from-[#3B4FE8] via-[#1D4ED8] to-[#1E40AF] p-8 sm:p-16 text-center shadow-2xl shadow-blue-900/20 overflow-hidden">
          ...
          <div className="relative z-10 max-w-3xl mx-auto">
            ...
            <div className="inline-flex items-center gap-2 bg-white/15 border border-white/25 text-white px-4 py-1.5 rounded-full text-xs font-bold mb-6 backdrop-blur-md shadow-sm">
              ...
              <span>انضم إلى +500 متجر ناجح على سلة مع Ecomate</span>
            </div>
            ...
            <p className="text-blue-100 text-base sm:text-lg leading-relaxed mb-10 max-w-2xl mx-auto font-medium">
              ابدأ تجربتك المجانية الكاملة اليوم مع Ecomate. وفر عشرات ساعات العمل الروتينية، واستمتع برضا عملائك الفوري.
            </p>
